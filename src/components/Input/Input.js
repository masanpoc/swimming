  ...
  return (
    <div className=" mb-32">
      ...
      >
        ...
        <div className="flex flex-col space-y-4 w-full border-2 border-lighter-grey border-opacity-40 pt-4  pb-5 px-4">
          ...
          <div className="flex flex-col text-left space-y-8">
            <h2>
              You can simply select a pace that you consider easy to moderate
              swimming.
            </h2>
            <h2>Or...</h2>
            <div className="flex flex-col space-y-7">
              <h2>
                <i>How to calculate your aerobic pace?</i>
              </h2>
              <ul className="list-decimal list-inside flex flex-col gap-4 pb-4 text-left">
                ...
                <li>
                  If you reached 12-18 beats per 10 seconds, that is your
                  aerobic pace. If not, try again with a different swimming
                  pace.
                </li>
              </ul>
            </div>
      ...
      >
        ...
        <h2 className={`text-left py-3 ${validation == 1 ? "" : "hidden"}`}>
          Please select at least one stroke
        </h2>
        <h2
          className={`text-left w-7/12 py-3 ${validation == 2 ? "" : "hidden"}`}
        >
          Please select one more stroke (in addition to butterfly)
        </h2>
      </div>
