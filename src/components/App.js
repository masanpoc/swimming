      ...
      <div className="p-0 m-0 w-full text-center ">
        ...
        <footer>
          ...
          <div className='flex w-full h-32 items-center'>
            <h2 className='font-play w-6/12 text-left px-6'><u><a href='https://github.com/masanpoc/swimming' rel='noreferrer' target='_blank'>Github repo</a></u></h2>
            <div className='flex items-center w-6/12 justify-center gap-2'>
              <h2 className='font-play '>Contact:</h2>
              <div className='flex gap-1'>
              <svg style={{"width":"30px", "height":"30px"}} viewBox="0 0 24 24">
                  <a href='mailto:marioscp1998@outlook.es' rel='noreferrer' target='_blank'>
              ...
              <svg style={{"width":"30px", "height":"30px"}} viewBox="0 0 24 24">
                  <a href='https://www.linkedin.com/in/mario-cirer/' rel='noreferrer' target='_blank'>
