    ...
    reducers: {
        ...
        filterByMaterial(state, action){
            ...
            if(material.length==5){
                ...
                let newState = state.slice();
                let materialsNotUsed = ['kickboard', 'fins', 'paddles', 'snorkel', 'pullbuoy'];
...
export const {filterByLevel, filterByStroke, filterByMaterial, resetList} = exercisesReducer.actions;
